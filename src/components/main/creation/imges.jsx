  ...
  return (
    <div>
      <div className="grid font-josefin xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 w-[79%] mx-[11.5%] ">
        <div className="md:mb-32 hover:opacity-25 cursor-pointer max-sm:mb-10 ">
          ...
          max-sm:text-[1.5rem] max-sm:w-[5rem] max-sm:leading-[1.5rem] max-sm:ml-[0.89rem] max-sm:mt-[-4.2rem]">
            DEEP EARTH
          </p>
        </div>
        <div className=" mb-32 hover:opacity-25 cursor-pointer max-sm:mb-10">
          ...
          <p
            className="w-[6rem] text-[2rem] font-[300] leading-[2rem] text-[#FFF]  relative  ml-[2.5rem] mt-[-6.4rem]
                    max-sm:text-[1.5rem] max-sm:w-[6.5rem] max-sm:leading-[1.5rem] max-sm:ml-[0.89rem] max-sm:mt-[-4.2rem]">
            NIGHT ARCADE
          </p>
        </div>
        <div className="mb-32 hover:opacity-25 cursor-pointer max-sm:mb-10">
        ...
        <div className="mb-32  hover:opacity-25 cursor-pointer max-sm:mb-10">
          ...
          <p
            className="w-[6rem] text-[2rem] font-[300] leading-[2rem] text-[#FFF]   relative  ml-[2.5rem] mt-[-6.4rem]
            max-sm:w-[7.7rem]       max-sm:text-[1.5rem] max-sm:leading-[1.5rem] max-sm:ml-[0.89rem] max-sm:mt-[-4.2rem]">
            POCKET BOREALIS
          </p>
        </div>
        <div className=" mb-32  hover:opacity-25 cursor-pointer max-sm:mb-10 ">
          ...
          <p
            className="w-[6rem]  text-[2rem] font-[300] leading-[2rem] text-[#FFF]  relative  ml-[2.5rem] mt-[-6.4rem]
            max-sm:w-[7.9rem]       max-sm:text-[1.5rem] max-sm:leading-[1.5rem] max-sm:ml-[0.89rem] max-sm:mt-[-4.2rem]">
            THE CURIOSITY
          </p>
        </div>
        <div className="mb-32  hover:opacity-25 cursor-pointer max-sm:mb-10">
